...
export function OldParty() {
    ...
    return (
        <div className={styles.commonOldParty}>
            ...
            <p>
                Агентство праздников PARTY STARS ® имеет богатый опыт в организации подарит Вам самые яркие незабываемые впечатления от Торжества, Юбилея, корпоратива компании, новогоднего или частного праздника. Мы предложим вам множество вариантов сценариев и сделать его действительно неповторимым. Работайте с профессионалами!
                Так же организуем квесты по желанию закасчика.
            </p>
            ...
            <h3 className="common_title">Ищете лучшего зазывалу для вашего праздничного мероприятия?</h3>
            <p>
            ...
            <h3 className="common_title">Лучшие артисты для корпоратива</h3>
            <p>
            Самые яркие и талантливые исполнители, танцоры , певцы и музыканты Нижнего Новгорода украсят своими выступлениями торжество и подарят массу положительных эмоций гостям праздника!
            </p>
            ...
            <h3 className="common_title">Лучшие шоу программы на корпоратив</h3>
            <p>
